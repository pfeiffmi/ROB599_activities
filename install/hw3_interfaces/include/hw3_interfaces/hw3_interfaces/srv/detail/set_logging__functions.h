...
#ifndef HW3_INTERFACES__SRV__DETAIL__SET_LOGGING__FUNCTIONS_H_
#define HW3_INTERFACES__SRV__DETAIL__SET_LOGGING__FUNCTIONS_H_
...
/// Initialize srv/SetLogging message.
/**
 ...
 * )) before or use
 * hw3_interfaces__srv__SetLogging_Request__create()
...
/// Finalize srv/SetLogging message.
/**
...
/// Create srv/SetLogging message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hw3_interfaces__srv__SetLogging_Request__init().
...
/// Destroy srv/SetLogging message.
/**
 * It calls
 * hw3_interfaces__srv__SetLogging_Request__fini()
...
/// Check for srv/SetLogging message equality.
/**
...
/// Initialize array of srv/SetLogging messages.
/**
...
/// Finalize array of srv/SetLogging messages.
/**
 * It calls
 * hw3_interfaces__srv__SetLogging_Request__fini()
...
/// Create array of srv/SetLogging messages.
/**
 * It allocates the memory for the array and calls
 * hw3_interfaces__srv__SetLogging_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetLogging messages.
/**
 * It calls
 * hw3_interfaces__srv__SetLogging_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetLogging message array equality.
/**
...
/// Copy an array of srv/SetLogging messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * hw3_interfaces__srv__SetLogging_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_hw3_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hw3_interfaces__srv__SetLogging_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hw3_interfaces
...
/**
 * It calls
 * hw3_interfaces__srv__SetLogging_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hw3_interfaces
...
/**
 * It allocates the memory for the array and calls
 * hw3_interfaces__srv__SetLogging_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hw3_interfaces
...
/**
 * It calls
 * hw3_interfaces__srv__SetLogging_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * hw3_interfaces__srv__SetLogging_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_hw3_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hw3_interfaces__srv__SetLogging_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hw3_interfaces
...
/**
 * It calls
 * hw3_interfaces__srv__SetLogging_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hw3_interfaces
...
/**
 * It allocates the memory for the array and calls
 * hw3_interfaces__srv__SetLogging_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hw3_interfaces
...
/**
 * It calls
 * hw3_interfaces__srv__SetLogging_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HW3_INTERFACES__SRV__DETAIL__SET_LOGGING__FUNCTIONS_H_
