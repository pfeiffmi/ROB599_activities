...
void Fibonacci_SendGoal_Event_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) rob599_msgs::action::Fibonacci_SendGoal_Event(_init);
}

void Fibonacci_SendGoal_Event_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rob599_msgs::action::Fibonacci_SendGoal_Event *>(message_memory);
  typed_message->~Fibonacci_SendGoal_Event();
}

size_t size_function__Fibonacci_SendGoal_Event__request(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<rob599_msgs::action::Fibonacci_SendGoal_Request> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<rob599_msgs::action::Fibonacci_SendGoal_Request> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<rob599_msgs::action::Fibonacci_SendGoal_Request> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__Fibonacci_SendGoal_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const rob599_msgs::action::Fibonacci_SendGoal_Request *>(
    get_const_function__Fibonacci_SendGoal_Event__request(untyped_member, index));
  auto & value = *reinterpret_cast<rob599_msgs::action::Fibonacci_SendGoal_Request *>(untyped_value);
  value = item;
}
...
void assign_function__Fibonacci_SendGoal_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<rob599_msgs::action::Fibonacci_SendGoal_Request *>(
    get_function__Fibonacci_SendGoal_Event__request(untyped_member, index));
  const auto & value = *reinterpret_cast<const rob599_msgs::action::Fibonacci_SendGoal_Request *>(untyped_value);
  item = value;
}
...
{
  const auto * member = reinterpret_cast<const std::vector<rob599_msgs::action::Fibonacci_SendGoal_Response> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<rob599_msgs::action::Fibonacci_SendGoal_Response> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<rob599_msgs::action::Fibonacci_SendGoal_Response> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__Fibonacci_SendGoal_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const rob599_msgs::action::Fibonacci_SendGoal_Response *>(
    get_const_function__Fibonacci_SendGoal_Event__response(untyped_member, index));
  auto & value = *reinterpret_cast<rob599_msgs::action::Fibonacci_SendGoal_Response *>(untyped_value);
  value = item;
}
...
void assign_function__Fibonacci_SendGoal_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<rob599_msgs::action::Fibonacci_SendGoal_Response *>(
    get_function__Fibonacci_SendGoal_Event__response(untyped_member, index));
  const auto & value = *reinterpret_cast<const rob599_msgs::action::Fibonacci_SendGoal_Response *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Fibonacci_SendGoal_Event_message_member_array[3] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rob599_msgs::action::Fibonacci_SendGoal_Event, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rob599_msgs::action::Fibonacci_SendGoal_Request>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(rob599_msgs::action::Fibonacci_SendGoal_Event, request),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rob599_msgs::action::Fibonacci_SendGoal_Response>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(rob599_msgs::action::Fibonacci_SendGoal_Event, response),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Fibonacci_SendGoal_Event_message_members = {
  ...
  3,  // number of fields
  sizeof(rob599_msgs::action::Fibonacci_SendGoal_Event),
  false,  // has_any_key_member_
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<rob599_msgs::action::Fibonacci_SendGoal_Event>()
{
  return &::rob599_msgs::action::rosidl_typesupport_introspection_cpp::Fibonacci_SendGoal_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rob599_msgs, action, Fibonacci_SendGoal_Event)() {
  return &::rob599_msgs::action::rosidl_typesupport_introspection_cpp::Fibonacci_SendGoal_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t Fibonacci_SendGoal_service_type_support_handle = {
  ...
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rob599_msgs::action::Fibonacci_SendGoal_Request>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rob599_msgs::action::Fibonacci_SendGoal_Response>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rob599_msgs::action::Fibonacci_SendGoal_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<rob599_msgs::action::Fibonacci_SendGoal>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<rob599_msgs::action::Fibonacci_SendGoal>,
...
get_service_type_support_handle<rob599_msgs::action::Fibonacci_SendGoal>()
{
    ...
    service_members->event_members_ == nullptr)
  {
    ...
    service_members->event_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::rob599_msgs::action::Fibonacci_SendGoal_Event
      >()->data
      );
  }
...
void Fibonacci_GetResult_Event_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) rob599_msgs::action::Fibonacci_GetResult_Event(_init);
}

void Fibonacci_GetResult_Event_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rob599_msgs::action::Fibonacci_GetResult_Event *>(message_memory);
...
{
  const auto * member = reinterpret_cast<const std::vector<rob599_msgs::action::Fibonacci_GetResult_Request> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<rob599_msgs::action::Fibonacci_GetResult_Request> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<rob599_msgs::action::Fibonacci_GetResult_Request> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__Fibonacci_GetResult_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const rob599_msgs::action::Fibonacci_GetResult_Request *>(
    get_const_function__Fibonacci_GetResult_Event__request(untyped_member, index));
  auto & value = *reinterpret_cast<rob599_msgs::action::Fibonacci_GetResult_Request *>(untyped_value);
  value = item;
}
...
void assign_function__Fibonacci_GetResult_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<rob599_msgs::action::Fibonacci_GetResult_Request *>(
    get_function__Fibonacci_GetResult_Event__request(untyped_member, index));
  const auto & value = *reinterpret_cast<const rob599_msgs::action::Fibonacci_GetResult_Request *>(untyped_value);
  item = value;
}
...
{
  const auto * member = reinterpret_cast<const std::vector<rob599_msgs::action::Fibonacci_GetResult_Response> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<rob599_msgs::action::Fibonacci_GetResult_Response> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<rob599_msgs::action::Fibonacci_GetResult_Response> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__Fibonacci_GetResult_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const rob599_msgs::action::Fibonacci_GetResult_Response *>(
    get_const_function__Fibonacci_GetResult_Event__response(untyped_member, index));
  auto & value = *reinterpret_cast<rob599_msgs::action::Fibonacci_GetResult_Response *>(untyped_value);
  value = item;
}
...
void assign_function__Fibonacci_GetResult_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<rob599_msgs::action::Fibonacci_GetResult_Response *>(
    get_function__Fibonacci_GetResult_Event__response(untyped_member, index));
  const auto & value = *reinterpret_cast<const rob599_msgs::action::Fibonacci_GetResult_Response *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Fibonacci_GetResult_Event_message_member_array[3] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rob599_msgs::action::Fibonacci_GetResult_Event, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rob599_msgs::action::Fibonacci_GetResult_Request>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(rob599_msgs::action::Fibonacci_GetResult_Event, request),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rob599_msgs::action::Fibonacci_GetResult_Response>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(rob599_msgs::action::Fibonacci_GetResult_Event, response),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Fibonacci_GetResult_Event_message_members = {
  ...
  3,  // number of fields
  sizeof(rob599_msgs::action::Fibonacci_GetResult_Event),
  false,  // has_any_key_member_
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<rob599_msgs::action::Fibonacci_GetResult_Event>()
{
  return &::rob599_msgs::action::rosidl_typesupport_introspection_cpp::Fibonacci_GetResult_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rob599_msgs, action, Fibonacci_GetResult_Event)() {
  return &::rob599_msgs::action::rosidl_typesupport_introspection_cpp::Fibonacci_GetResult_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t Fibonacci_GetResult_service_type_support_handle = {
  ...
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rob599_msgs::action::Fibonacci_GetResult_Request>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rob599_msgs::action::Fibonacci_GetResult_Response>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rob599_msgs::action::Fibonacci_GetResult_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<rob599_msgs::action::Fibonacci_GetResult>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<rob599_msgs::action::Fibonacci_GetResult>,
...
get_service_type_support_handle<rob599_msgs::action::Fibonacci_GetResult>()
{
    ...
    service_members->event_members_ == nullptr)
  {
    ...
    service_members->event_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::rob599_msgs::action::Fibonacci_GetResult_Event
      >()->data
      );
  }
  // finally return the properly initialized service_type_support handle
