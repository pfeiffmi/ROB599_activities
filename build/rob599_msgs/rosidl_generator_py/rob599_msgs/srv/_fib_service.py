...
class Metaclass_FibService_Event(type):
    """Metaclass of message 'FibService_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__fib_service__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__fib_service__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__fib_service__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__fib_service__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__fib_service__event
...
class FibService_Event(metaclass=Metaclass_FibService_Event):
    """Message class 'FibService_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rob599_msgs/FibService_Request, 1>',
        'response': 'sequence<rob599_msgs/FibService_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rob599_msgs', 'srv'], 'FibService_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rob599_msgs', 'srv'], 'FibService_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rob599_msgs.srv import FibService_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, FibService_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'FibService_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rob599_msgs.srv import FibService_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, FibService_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'FibService_Response'"
...
class Metaclass_FibService(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _fib_service.Metaclass_FibService_Event._TYPE_SUPPORT is None:
                _fib_service.Metaclass_FibService_Event.__import_type_support__()
...
class FibService(metaclass=Metaclass_FibService):
    ...
    from rob599_msgs.srv._fib_service import FibService_Event as Event
