...
#include "rob599_msgs/msg/detail/object__rosidl_typesupport_fastrtps_c.h"
...
using _Object__ros_msg_type = rob599_msgs__msg__Object;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rob599_msgs__msg__Object;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rob599_msgs__msg__Object * ros_message = static_cast<const rob599_msgs__msg__Object *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rob599_msgs__msg__Object(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rob599_msgs__msg__Object * ros_message = static_cast<rob599_msgs__msg__Object *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rob599_msgs__msg__Object(cdr, ros_message);
}

static uint32_t _Object__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rob599_msgs__msg__Object(
...
static size_t _Object__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rob599_msgs__msg__Object(
