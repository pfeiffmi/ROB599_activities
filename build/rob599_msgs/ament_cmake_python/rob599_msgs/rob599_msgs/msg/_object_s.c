...
bool rob599_msgs__msg__object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rob599_msgs.msg._object.Object", full_classname_dest, 30) == 0);
  }
  rob599_msgs__msg__Object * ros_message = _ros_message;
  {  // name
...
PyObject * rob599_msgs__msg__object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rob599_msgs.msg._object");
