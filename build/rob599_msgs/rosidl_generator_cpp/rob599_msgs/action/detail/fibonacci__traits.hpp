...
[[deprecated("use rob599_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const rob599_msgs::action::Fibonacci_SendGoal_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  rob599_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use rob599_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const rob599_msgs::action::Fibonacci_SendGoal_Event & msg)
{
  return rob599_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<rob599_msgs::action::Fibonacci_SendGoal_Event>()
{
  return "rob599_msgs::action::Fibonacci_SendGoal_Event";
}

template<>
inline const char * name<rob599_msgs::action::Fibonacci_SendGoal_Event>()
{
  return "rob599_msgs/action/Fibonacci_SendGoal_Event";
}

template<>
struct has_fixed_size<rob599_msgs::action::Fibonacci_SendGoal_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<rob599_msgs::action::Fibonacci_SendGoal_Event>
  : std::integral_constant<bool, has_bounded_size<rob599_msgs::action::Fibonacci_SendGoal_Request>::value && has_bounded_size<rob599_msgs::action::Fibonacci_SendGoal_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<rob599_msgs::action::Fibonacci_SendGoal_Event>
  : std::true_type {};
...
[[deprecated("use rob599_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const rob599_msgs::action::Fibonacci_GetResult_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  rob599_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use rob599_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const rob599_msgs::action::Fibonacci_GetResult_Event & msg)
{
  return rob599_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<rob599_msgs::action::Fibonacci_GetResult_Event>()
{
  return "rob599_msgs::action::Fibonacci_GetResult_Event";
}

template<>
inline const char * name<rob599_msgs::action::Fibonacci_GetResult_Event>()
{
  return "rob599_msgs/action/Fibonacci_GetResult_Event";
}

template<>
struct has_fixed_size<rob599_msgs::action::Fibonacci_GetResult_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<rob599_msgs::action::Fibonacci_GetResult_Event>
  : std::integral_constant<bool, has_bounded_size<rob599_msgs::action::Fibonacci_GetResult_Request>::value && has_bounded_size<rob599_msgs::action::Fibonacci_GetResult_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<rob599_msgs::action::Fibonacci_GetResult_Event>
  : std::true_type {};
