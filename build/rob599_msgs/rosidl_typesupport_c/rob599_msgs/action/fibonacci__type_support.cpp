...
static const _Fibonacci_SendGoal_Event_type_support_symbol_names_t _Fibonacci_SendGoal_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rob599_msgs, action, Fibonacci_SendGoal_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rob599_msgs, action, Fibonacci_SendGoal_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rob599_msgs, action, Fibonacci_SendGoal_Event)() {
  return &::rob599_msgs::action::rosidl_typesupport_c::Fibonacci_SendGoal_Event_message_type_support_handle;
}
...
static const _Fibonacci_GetResult_Event_type_support_symbol_names_t _Fibonacci_GetResult_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rob599_msgs, action, Fibonacci_GetResult_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rob599_msgs, action, Fibonacci_GetResult_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rob599_msgs, action, Fibonacci_GetResult_Event)() {
  return &::rob599_msgs::action::rosidl_typesupport_c::Fibonacci_GetResult_Event_message_type_support_handle;
}
