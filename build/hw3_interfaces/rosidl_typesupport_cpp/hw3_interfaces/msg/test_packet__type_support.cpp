...
static const _TestPacket_type_support_symbol_names_t _TestPacket_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hw3_interfaces, msg, TestPacket)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hw3_interfaces, msg, TestPacket)),
  }
};
...
{
  return &::hw3_interfaces::msg::rosidl_typesupport_cpp::TestPacket_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hw3_interfaces, msg, TestPacket)() {
  return get_message_type_support_handle<hw3_interfaces::msg::TestPacket>();
}
