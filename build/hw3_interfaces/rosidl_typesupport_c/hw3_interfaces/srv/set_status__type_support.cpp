...
static const _SetStatus_Request_type_support_symbol_names_t _SetStatus_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hw3_interfaces, srv, SetStatus_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hw3_interfaces, srv, SetStatus_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hw3_interfaces, srv, SetStatus_Request)() {
  return &::hw3_interfaces::srv::rosidl_typesupport_c::SetStatus_Request_message_type_support_handle;
}
...
static const _SetStatus_Response_type_support_symbol_names_t _SetStatus_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hw3_interfaces, srv, SetStatus_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hw3_interfaces, srv, SetStatus_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hw3_interfaces, srv, SetStatus_Response)() {
  return &::hw3_interfaces::srv::rosidl_typesupport_c::SetStatus_Response_message_type_support_handle;
}
...
static const _SetStatus_Event_type_support_symbol_names_t _SetStatus_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hw3_interfaces, srv, SetStatus_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hw3_interfaces, srv, SetStatus_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hw3_interfaces, srv, SetStatus_Event)() {
  return &::hw3_interfaces::srv::rosidl_typesupport_c::SetStatus_Event_message_type_support_handle;
}
...
static const _SetStatus_type_support_symbol_names_t _SetStatus_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hw3_interfaces, srv, SetStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hw3_interfaces, srv, SetStatus)),
  }
};
...
static const rosidl_service_type_support_t SetStatus_service_type_support_handle = {
  ...
  &SetStatus_Request_message_type_support_handle,
  &SetStatus_Response_message_type_support_handle,
  &SetStatus_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, hw3_interfaces, srv, SetStatus)() {
  return &::hw3_interfaces::srv::rosidl_typesupport_c::SetStatus_service_type_support_handle;
}
